...
;
          if (!runningTests) {
            require("cfi2-coderdojo-site/app")["default"].create({"name":"cfi2-coderdojo-site","version":"0.0.0+fd8b6ecf"});
          }
